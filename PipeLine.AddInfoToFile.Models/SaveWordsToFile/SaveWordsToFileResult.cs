...
{
    public class SaveWordsToFileResult : IResultContainer<SaveWordsToFileOutModel>
    {
        private readonly List<ApplicationException> _appErrors;

        public SaveWordsToFileResult(SaveWordsToFileOutModel result)
        {
            _appErrors = new List<ApplicationException>();
            Value = result;
        }
        public SaveWordsToFileOutModel Value { get; }
